...
<main class="cd-main-content" style="background-color: #fff"><!--FAFAFA-->
    ...
    <div id="wrapper">
        ...
        <div id="sidebar">
            ...
            <h3>LOCALITY</h3>
            <div class="checklist categories" style="overflow-y:scroll; overflow-x:hidden; height:500px;">
                <ul>
...
-->
    ...
    <span class="survey-country list-only">'.$row['email'] . '</span><span class="survey-name">
      Database Management<i class="fa fa-heart-o" style="margin-left: 17px"></i>
    </span><br><span class="survey-country grid-only">'.$row['firstname'].'&nbsp;'.$row['lastname'].'<br>'.$row['email'].'<br>'.$row['mobile'].'</span><div class="pull-right">
